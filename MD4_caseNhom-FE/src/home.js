...
function showMySong() {
    ...
    $.ajax({
        ...
        success: (data) => {
                let playlistAudio = {}; // tao doi tuong
                let html = ``;
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <center class="col-lg-12 col-12">
                                ...
                                <div class="container">
                                    <button class="btn btn-primary" onclick="play_audio('play')">PLAY</button> //nut play
                                    <button class="btn btn-danger" onclick="play_audio('stop')">STOP</button> ///nut stop
                                </div>
                            </center>`
                data[0].map((item) => {
                    playlistAudio['song_'+item.idSong] = item.sound;// them thuoc tinh vao doi tuong
                    html += `<div class="col-lg-6 col-12 mt-4 mb-lg-0">
                                <div class="custom-block d-flex">
                                    <div class="">
                                        <div class="custom-block-icon-wrap" style="width: 120px; height: 150px;">
